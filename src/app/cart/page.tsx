...
export default function Cart() {
  ...
  const items = [
    ...
    },
    {
      ...
      description: (
        <div className="pt-8">
          Yes. We offer a 0% service fee for the first 12 months following an
          investment on primary sales, which applies when an investor purchases
          their wine directly from Vinesia’s initial inventory. Please note that
          this does not apply to secondary sales on the Vinesia marketplace.
          After the first year, a service fee of 2.4% per annum is applied. This
          fee covers the core tech that enables Vinesia to offer our “Peace of
          Mind” pledge towards our investors (Proof of Authenticity, Proof of
          Ownership, Proof of Storage Conditions).It also covers the costs of
          storage, insurance, and optimal storage conditions.Finally, it funds
          the development of new functionalities which are on our roadmap for
          the future. The 2.4% service decreases based on the volume of your
          investments (Asset Under Management, AUM).
        </div>
      ),
    },
  ];
