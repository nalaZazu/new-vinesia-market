    ...
    <React.Fragment>
      <div className="max-w-[560px] cotainer mx-auto py-8">
        <div className="relative pb-12 px-4">
          <div className="md:pt-20 pt-[60px] ">
            <div className="pb-2 md:px-6 pt-[60px]  bg-orange-50 rounded-tl-[20px] rounded-tr-[20px] border border-orange-700 border-opacity-20 ">
              ...
              <div className="flex-col justify-center items-center  flex ">
                <h3 className="  text-green-500 md:text-4xl font-light pt-8  md:leading-[44px]    text-center  md:text-[21px]  leading-[29px]">
                  Your purchase is complete
                </h3>
                <p className="  text-green-700 md:py-4  pt-2 text-base font-normal md:leading-snug text-center leading-snug">
          ...
          {/* here is total view  */}
          <button className="w-full px-2.5 py-5 bg-orange-100 rounded-bl-[20px] rounded-br-[20px] border-l border-r border-b border-orange-700 border-opacity-20  text-center  text-orange-700 text-xs font-normal  uppercase leading-[18px] tracking-tight  justify-center items-center gap-2.5 flex">
            VIEW ON POLYGON{" "}
            <span>
          ...
          {/* end of relative div */}
          <div className="absolute top-[380px] right-[-61px] -z-10 md:block hidden">
            <Image src={grapes} alt="image-icon" />
          </div>
          <div className="absolute top-[250px] left-[-63px] -z-10 md:block hidden">
