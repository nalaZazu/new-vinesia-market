...
export default function ProductCards() {
  return (
    <div className=" grid grid-cols-1 lg:grid-cols-3 md:grid-cols-1 max-w-[1046px] mx-auto gap-8 px-4">
        ...
        return (
          ...
          >
            <div className="max-w-[501px] md:h-[674px] h-[674px] left-0 mx-auto">
              <div className="flex justify-center max-w-[501px] -mt-6 md:-mt-6">
                <Image
                  src={winebotel}
              ...
              <div className="max-w-[437px] mx-auto flex justify-between items-center pt-8 px-6">
