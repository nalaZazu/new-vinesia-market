      ...
      <div>
        ...
        <div className=" grid gap-0 lg:grid-cols-4 md:grid-cols-1 grid-cols-1 pt-6">
          ...
          <div className=" gap-10 rounded-bl border-l border-t border-b md:border-r-0 border-r border-orange-700 border-opacity-20 flex-col justify-between items-start flex p-5">
            <div>
              <p className="  text-[#906447] text-xs font-normal uppercase leading-3 tracking-tight">
                Highest Price
              </p>
              <p className=" text-stone-400 text-xs font-normal  leading-3 pt-1">
          ...
          <div className="gap-10 p-5 bg-slate-700  border border-orange-700 border-opacity-20 flex-col justify-between items-start inline-flex">
            <div>
              ...
              <p className=" text-slate-400 text-xs font-normal  leading-3 pt-1">
                since first release
              </p>
            </div>
