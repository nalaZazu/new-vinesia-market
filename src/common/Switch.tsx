  ...
  return (
    <div className="flex">
      <Switch
        ...
        onChange={setEnabled}
        className={`${
          enabled ? "opacity-50 bg-stone-400" : "opacity-50 bg-stone-400"
        }
      ...
      >
        ...
        <span
          ...
          className={`${enabled ? "translate-x-3" : "translate-x-0"}
            pointer-events-none  h-[16px] w-[16px] transform rounded-full bg-white shadow-lg transition duration-200 ease-in-out opacity-50`}
        />
      </Switch>
    </div>
  );
